    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 text-white relative">
      ...
      <div className="relative z-10">
        ...
        <section className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4">
              <h1 className="font-bold mb-6 text-white drop-shadow-lg text-[clamp(1.2rem,5vw,2.5rem)] md:text-[clamp(2.5rem,4vw,4rem)] break-words text-balance">
                Welcome to <span className="text-teal-400 break-words text-balance">TANZIL EDUCATION CENTRE</span>
              </h1>
              <p className="text-lg md:text-xl text-white max-w-3xl mx-auto drop-shadow-lg break-words text-balance">
        ...
        <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-12 text-white break-words text-balance">Why Choose Tanzil?</h2>
      ...
      {/* Contact Section */}
        <section className="py-16">
        <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center mb-12 text-white break-words text-balance">Contact Us</h2>
